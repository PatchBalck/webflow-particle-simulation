...
if (!container) {
  console.error('Boombox container #boombox-hero-container not found!');
  throw new Error('Boombox container not found');
}
...
rgbeLoader.load(
  'https://cdn.jsdelivr.net/gh/PatchBlack/patchblack-code@main/assets/textures/royal_esplanade_1k.hdr',
  (texture) => {
...
// ===== AUDIO SETUP =====
const audio = new Audio('https://cdn.jsdelivr.net/gh/PatchBlack/patchblack-code@main/assets/audio/Boombox-audio.mp3');
let isPlaying = false;
...
loader.load(
  'https://cdn.jsdelivr.net/gh/PatchBlack/patchblack-code@main/assets/models/Boombox-01.glb',
  (gltf) => {
    boombox = gltf.scene;
    ...
    // ===== NOTIFY PRELOADER BOOMBOX IS LOADED =====
    if (window.onBoomboxLoaded) {
      window.onBoomboxLoaded();
    }
    console.log('Boombox model loaded successfully');
  },
  undefined,
  (error) => {
